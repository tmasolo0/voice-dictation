...
```json
{
  ...
  "recognition": {
    ...
    "language": "auto",
    "beam_size": 5,
    "custom_terms": ["Claude Code", "VS Code", "GitHub", "Python"]
  }
}
```
...
Список терминов, которые модель учитывает при распознавании. Добавь сюда специфичные слова из твоей работы — имена продуктов, технические термины, аббревиатуры. Это улучшает точность.
...
**Плохое распознавание** — добавь специфичные термины в `config.json` → `recognition.custom_terms`
